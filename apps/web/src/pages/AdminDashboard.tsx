...
export const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-[88vh] bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <main className="flex-1 flex flex-col bg-slate-50 min-w-0 overflow-hidden">
        ...
        <header className="bg-white border-b border-slate-200 px-4 sm:px-6 py-3 flex items-center justify-between flex-shrink-0">
          ...
          <div className="flex items-center space-x-3">
            {/* Live Disaster Clock */}
            <div className="hidden sm:flex items-center space-x-1.5 px-3 py-1 bg-slate-100 border border-slate-200 rounded-lg text-xs font-mono font-bold text-slate-800">
            ...
            <button
              ...
              className="hidden md:inline-flex items-center space-x-1.5 px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-800 border border-slate-300 rounded-lg text-xs font-bold transition-colors"
        ...
        <div className="flex-1 p-4 sm:p-6 overflow-y-auto max-h-[calc(88vh-55px)] space-y-6">
          ...
          {activeTab === 'overview' && (
            <div className="space-y-6">
              ...
              {criticalOnlyCount > 0 && (
                <div className="bg-red-50 border border-red-200 rounded-2xl p-4 sm:p-5 flex items-start justify-between gap-3 shadow-2xs">
