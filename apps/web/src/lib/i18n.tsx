...
const translations: Record<Locale, Record<string, string>> = {
  ne: {
    ...
    'apply.step4': '४. सामग्री तथा ढुवानी विवरण',
    ...
    'apply.vehicleTypeMotorcycle': 'मोटरसाइकल / बाइक (Motorcycle / Bike)',
    'apply.vehicleTypeScooter': 'स्कुटर (Scooter)',
    'apply.vehicleTypeAmbulance': 'एम्बुलेन्स (Ambulance)',
    'apply.vehicleTypeJeep': 'जिप / एसयूभी / ४x४ (Jeep / SUV / 4WD)',
    'apply.vehicleTypePickup': 'पिकअप (Pickup Truck)',
    'apply.vehicleTypeTruck': 'ट्रक / टिपर (Truck / Tipper)',
    'apply.vehicleTypeBus': 'बस (Bus)',
    'apply.vehicleTypeMicrobus': 'माइक्रोबस / हाइस / भ्यान (Microbus / HiAce / Van)',
    'apply.vehicleTypeCar': 'कार / सेडान / ट्याक्सी (Car / Taxi)',
    'apply.vehicleTypeTractor': 'ट्र्याक्टर (Tractor)',
    ...
    'apply.errInvalidPhone': 'कृपया मान्य १० अङ्कको मोबाइल नम्बर प्रविष्ट गर्नुहोस् (उदा: ९८XXXXXXXX)',
    'apply.errInvalidEmail': 'कृपया मान्य इमेल ठेगाना प्रविष्ट गर्नुहोस्',
    'apply.errOrg': 'कृपया संस्थाको नाम प्रविष्ट गर्नुहोस्',
    'apply.errVehicleNo': 'कृपया सवारी दर्ता नम्बर प्रविष्ट गर्नुहोस्',
    'apply.errInvalidVehicleNo': 'कृपया मान्य सवारी नम्बर प्रविष्ट गर्नुहोस् (कम्तीमा ३ अक्षर)',
    ...
    'apply.errSameLocation': 'प्रस्थान स्थान र गन्तव्य एउटै हुन सक्दैन',
    'apply.errRoute': 'कृपया प्रस्तावित मार्ग प्रविष्ट गर्नुहोस्',
    'apply.errDepartureTime': 'कृपया प्रस्थान समय प्रविष्ट गर्नुहोस्',
    'apply.errInvalidReturnTime': 'फिर्ता हुने समय प्रस्थान समयभन्दा पछि हुनुपर्छ',
    'apply.errPurpose': 'कृपया यात्राको उद्देश्य प्रविष्ट गर्नुहोस्',
    'apply.errCargo': 'कृपया सामग्रीको विस्तृत विवरण प्रविष्ट गर्नुहोस्',
  ...
  en: {
    ...
    'apply.vehicleTypeMotorcycle': 'Motorcycle / Bike',
    'apply.vehicleTypeScooter': 'Scooter',
    'apply.vehicleTypeAmbulance': 'Ambulance',
    'apply.vehicleTypeJeep': 'Jeep / SUV / 4WD',
    'apply.vehicleTypePickup': 'Pickup Truck',
    'apply.vehicleTypeTruck': 'Truck / Tipper',
    'apply.vehicleTypeBus': 'Bus',
    'apply.vehicleTypeMicrobus': 'Microbus / HiAce / Van',
    'apply.vehicleTypeCar': 'Car / Sedan / Taxi',
    'apply.vehicleTypeTractor': 'Tractor',
    'apply.vehicleTypeBoat': 'Boat / Special Rescue',
    ...
    'apply.errInvalidPhone': 'Please enter a valid 10-digit mobile number (e.g. 98XXXXXXXX)',
    'apply.errInvalidEmail': 'Please enter a valid email address',
    'apply.errOrg': 'Please enter organization name',
    'apply.errVehicleNo': 'Please enter vehicle registration plate number',
    'apply.errInvalidVehicleNo': 'Please enter a valid vehicle plate number (min 3 characters)',
    ...
    'apply.errSameLocation': 'Departure and destination locations cannot be identical',
    'apply.errRoute': 'Please enter proposed travel route / corridor',
    'apply.errDepartureTime': 'Please select departure date & time',
    'apply.errInvalidReturnTime': 'Estimated return time must be after departure time',
