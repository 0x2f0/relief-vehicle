...
const translations: Record<Locale, Record<string, string>> = {
  ne: {
    ...
    // Track Application
    'track.title': 'ई-पास आवेदन स्थिति ट्रयाकिङ',
    'track.subtitle': 'आवेदन गर्दा प्राप्त भएको Application ID प्रविष्ट गर्नुहोस्',
    'track.placeholder': 'Application ID (उदा: APP-2026-8801 वा EP-20260829-0DE4)',
  ...
  en: {
    ...
    'track.placeholder': 'Application ID (e.g. APP-2026-8801 or EP-20260829-0DE4)',
